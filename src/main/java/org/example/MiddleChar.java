...
public class MiddleChar {
    ...
    public static void main(String[] args) {
        System.out.println(getMiddle("abcfgba"));
    }
    ...
    public static String getMiddle(String word) {
        ...
        if (letters.length % 2 == 0) {
            return String.valueOf(letters[(letters.length / 2) - 1]) + letters[letters.length / 2];
        } else {
            return String.valueOf(letters[letters.length / 2]);
        }
    }
}
